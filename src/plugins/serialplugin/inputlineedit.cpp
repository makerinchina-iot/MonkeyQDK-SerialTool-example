...
InputLineEdit::InputLineEdit(QWidget *parent) :
    ...
    m_maxEntries(20)
{
    connect(this, &QLineEdit::returnPressed, this, &InputLineEdit::addHistoryEntry);
}

// Add current text to history entries, if not empty and different from last entry.
// Called when return key is pressed.
void InputLineEdit::addHistoryEntry()
{
...
void InputLineEdit::loadHistoryEntry(int entryIndex)
{
