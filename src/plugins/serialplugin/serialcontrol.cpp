    ...
    QObject(parent)
{
    ...
    m_initialDtrState = false;
    m_initialRtsState = false;
    m_clearInputOnSend = false;
...
void SerialControl::appendMessage(const QString &msg, Settings::OutputFormat format)
{
...
void SerialControl::handleReadyRead()
{
    ...
    appendMessage(QString::fromUtf8(ba), Settings::StdOutFormat);
